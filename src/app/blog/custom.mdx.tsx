...
export const MDXComponents = {
	...
	a: ({ children, className, ...props }) => (
		<a
			...
			className={cn(
				className as string,
				"relative inline-flex items-center justify-center bg-gradient-to-br from-green-text-primary to-red-text-primary bg-clip-text font-medium text-transparent before:absolute before:bottom-0 before:h-px before:w-full before:rounded-full before:bg-gradient-to-br before:from-orange-text-primary before:to-red-text-primary hover:opacity-90",
			)}
			target="_blank"
